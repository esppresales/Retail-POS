 ...
 */
public class CustomerDetailAdapter extends ArrayAdapter<CustomerWrapper.CustomerTransactionWrapper> {
    List<CustomerWrapper.CustomerTransactionWrapper> data;
    Context mContext;
    Fragment mFragment;
    int deviceWidth;
    int deviceHeight;
    ...
    public CustomerDetailAdapter(Fragment fragment,
                                 List<CustomerWrapper.CustomerTransactionWrapper> data) {
    ...
    @Override
    public CustomerWrapper.CustomerTransactionWrapper getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CustomerWrapper.CustomerTransactionWrapper _objModel = data.get(position);
        ...
        holder.amount.setText( _objModel.getAmount());
