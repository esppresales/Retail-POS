...
import com.printer.epos.rtpl.adapter.StaffAdapter;
...
public class StaffFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onResume() {
        ...
        StaffWrapper.getStaffList(null, getActivity(), this);

        ((Home) getActivity()).setTitleText(getString(R.string.staff));
...
//        floatingActionButton_param.height = (int)(deviceHeight*.2f);
        ...
        LinearLayout ListHeading = (LinearLayout)rootView.findViewById(R.id.ListHeading);
        RelativeLayout.LayoutParams ListHeading_param = (RelativeLayout.LayoutParams) ListHeading.getLayoutParams();
        ListHeading_param.height = (int)(deviceHeight*.1f);
        ListHeading_param.leftMargin = (int) (deviceWidth * .02f);
        ListHeading_param.rightMargin = (int) (deviceWidth * .02f);
        ListHeading.setLayoutParams(ListHeading_param);

        TextView name = (TextView) rootView.findViewById(R.id.heading_name);
        name.getLayoutParams().width = (int) (deviceWidth   * .28f);

       /* TextView mobile = (TextView) rootView.findViewById(R.id.heading_mobile);
        mobile.getLayoutParams().width = (int) (deviceWidth * .12f);*/

        TextView userName = (TextView) rootView.findViewById(R.id.heading_username);
        userName.getLayoutParams().width = (int) (deviceWidth * .15f);

        TextView role = (TextView) rootView.findViewById(R.id.heading_role);
        role.getLayoutParams().width = (int) (deviceWidth * .12f);

        TextView lastLogin = (TextView) rootView.findViewById(R.id.heading_last_login);
        lastLogin.getLayoutParams().width = (int) (deviceWidth * .28f);

        TextView status = (TextView) rootView.findViewById(R.id.heading_status);
//        status.getLayoutParams().width = (int) (deviceWidth * .1f);
    ...
    public void setStaffAdapter(List<StaffWrapper> data) {

            mAdapter = new StaffAdapter(StaffFragment.this, data);
...
//                    }
                    ...
                    RetailPosLoging.getInstance().registerLog(StaffFragment.class.getName(),ex);
                    ex.printStackTrace();
                }
            }
...
//                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                ...
                arguments.putString(OrderPreviewFragment.ARG_ITEM_ID, "21");
